  ...
  return (
    <footer className="footer sm:footer-horizontal bg-[#1c1c1c] text-base-content p-10">
      ...
      <nav>
        ...
        <Link to="/developers" className="link link-hover">Developers</Link>
      ...
      <nav>
        ...
        <Link to="/onboarding" className="link link-hover">Onboarding</Link>
        <Link to="/settings" className="link link-hover">Settings</Link>
      </nav>
      <nav>
        <h6 className="footer-title">Legal</h6>
        <Link to="/legal/terms" className="link link-hover">Terms of use</Link>
