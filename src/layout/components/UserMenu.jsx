...
export const UserMenu = ({ profile, logout }) => {
  return (
    <ul tabIndex={0} className='dropdown-content mt-2 menu bg-neutral-60 rounded-box min-w-38 lg:min-w-48 left-1 '>
                ...
                >
                  <p className="flex items-center gap-2"><PiGear className='text-xl' />Settings</p> 
                </Link></li>
                </>
